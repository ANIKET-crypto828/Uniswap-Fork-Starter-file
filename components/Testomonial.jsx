      ...
      <div className="row justify-content-center">
        <div className="col-lg-5 text-center wow fadeInUp" data-wow-duration="0.3s" data-wow-delay="0.3s">
          <div className="section-head">
            ...
            <p className="text">
              We are a team of experienced professionals who have come together to create a platform that makes it easy for you to swap your cryptocurrencies with the best rates in the market.
            </p>
          </div>
        </div>
      </div>
                ...
                <div id="myPopover" className="popover popover-default mypopover">
                  <div className="client-review">
                    ...
                    <p className="bottom-text">
                      I have been using this platform for a while now and I must say it's been a game changer for me. The interface is easy to navigate and the rates are always up to date. I highly recommend it to anyone looking for a secure and reliable way to swap their cryptocurrencies.
                    </p>
